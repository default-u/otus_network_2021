...
**Схема L2 пиринга:**  
![image](https://user-images.githubusercontent.com/8961955/150826732-2d82d962-8c7d-46ef-8a59-0f7bbe754703.png)
...
Итого, поставленная задача выполнена - хост 192.168.1.34 успешно перенесен из AS65013 в AS65011, в AS65012 добавлен хост 192.168.1.13, связь между всеми устройствами в сети 192.168.1.0/24 работает. Резервирование каналов связи осуществляется на уровне L3 BGP. Базовая связность L3 также функционирует.    
