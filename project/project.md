...
Итого, поставленная задача выполнена - хост 192.168.1.34 успешно перенесен из AS65013 в AS65011, в AS65012 добавлен хост 192.168.1.13, связь между всеми устройствами в сети 192.168.1.0/24 hf,jnftn  
